function [sec_eig, sec_eig_true, sec_eig_incl_cs, length_sec] = ...
    form_sectors_spca(PC,alpha,site_freq_no_mutation,true_indices,ls)

% Code to form sectors using the SPCA method
% 
...
%                           using the SPCA method and supplemented by the 
%                           100% conserved sites
