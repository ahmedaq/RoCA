%%
% *CODE FOR IDENTIFYING CO-EVOLUTIONARY SECTORS IN HCV NS3-4A USING RoCA*
...
load msa_ns34a
[B,Bcap,lambda,site_freq_no_mutation,true_indices,freq_bin,prev_aa,N,M,ls] = preprocessing_ns34a(msa);
