function [B,Bcap,lambda,site_freq_no_mutation,true_indices,freq_bin,prev_aa,N,M,ls] = preprocessing_nef(A)

%Code for preprocessing the HIV Nef data
% 
...
outlying_seqs = obtain_outlying_seqs_nef(A);
A(outlying_seqs,:) = [];
