function [B,Bcap,lambda,site_freq_no_mutation,true_indices,freq_bin,prev_aa,N,M,ls] = preprocessing_ns4b(A)

%Code for preprocessing the HCV NS4B data
% 
...
outlying_seqs = obtain_outlying_seqs_ns4b(A);
A(outlying_seqs,:) = [];
